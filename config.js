// ================================================================
//  m's hub — GAS エンドポイント設定
//  GAS URLを変更する場合はこのファイルだけ修正してください
// ================================================================
const GAS_URLS = {
  // タスク管理 GAS（施工管理_タスク管理）
  TASK: 'https://script.google.com/macros/s/AKfycbwLo2VCUvfu0XVGzuni7A1AyqES9oAkC6Yap_LaKh_2ljOzAmzaFkVwNcYynz9G1zf-/exec',
  // 支払い管理 GAS
  PAYMENT: 'https://script.google.com/macros/s/AKfycbw01hej9MyJcyZ8vuoWIZztCu0-kjPHYl45QyEwjIJYAe5DYxBgah427dMqz-NrCW8y/exec',
